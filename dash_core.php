...
$Definition['<strong>Categories</strong> allow you to organize your discussions. Categories can only contain discussions.'] = '<strong>Kategorier</strong> låter dig organisera dina trådar. Kategorier kan endast innehålla trådar.';
$Definition['<strong>Heads Up!</strong> Deleting a role can result in users not having access to the application.'] = '<strong>OBS!</strong> Att ta bort en roll kan resultera i att användare inte har tillgång till applikationen.';
$Definition['<strong>Heads Up!</strong> Moving discussions into a replacement category can result in discussions vanishing (or appearing) if the replacement category has different permissions than the category being deleted.'] = '<strong>OBS!</strong> Om du flyttar trådar till en ersättande kategori kan det hända att trådar försvinner (eller dyker upp) om den nya kategorin har andra behörigheter än kategorin du raderar.';
...
$Definition['All categories listed with a selection of 5 recent discussions under each'] = 'Alla kategorier listade med ett urval av 5 nya trådar under varje';
$Definition['All Dashboard Pages'] = 'Alla kontrollpanelsidor';
$Definition['All discussions in this category will be permanently deleted.'] = 'Alla trådar i den här kategorin kommer att raderas permanent.';
...
$Definition['Archive Discussions'] = 'Arkivera trådar';
...
$Definition['Auto-Fetch New Comments'] = 'Hämta nya inlägg automatiskt';
...
$Definition['Capture definitions throughout the site. You must visit the pages in the site in order for the definitions to be captured. The captured definitions will be put in the <code>captured.php</code> and <code>captured_admin.php</code>.'] = 'Fånga definitioner på hela webbplatsen. Du måste besöka sidorna på webbplatsen för de definitioner som ska fångas. De tagna definitioner kommer att sättas i <code> captured.php </ code> och <code> captured_admin.php </ code>.';
$Definition['Categories &amp; Discussions'] = 'Kategorier & trådar';
$Definition['Categories are used to help organize discussions.'] = 'Kategorier används för att sortera och organisera trådar. Dra och släpp kategorier för att sortera och nästa dem.';
$Definition['Categories are used to organize discussions.'] = '<strong>Kategorier</strong> låter dig sortera och organisera trådar.';
...
$Definition['Changing the Discussions Menu Link'] = 'Ändra länken till trådmenyn';
...
$Definition['Choose how to handle all of the content associated with the user account for %s (comments, messages, etc).'] = 'Välj hur allt innehåll förknippat med användaren %s ska hanteras (inlägg, meddelanden osv).';
...
$Definition['Choose the preferred layout for the discussions page.'] = 'Välj den layout du föredrar för trådsidan.';
...
$Definition['Comment  Body'] = 'Svar  Innehåll';
$Definition['Comment  Subject'] = 'Svar  Ämne';
$Definition['Comment Settings'] = 'Svarsinställningar';

$Definition['comment(s)'] = 'svar';

$Definition['Comments Page'] = 'Svarssida';
$Definition['Comments per Page'] = 'Svar per sida';
...
$Definition['Create & organize discussion categories and manage your users.'] = 'Skapa och organisera kategorier för trådar och hantera dina användare.';
$Definition['Create & organize discussion categories, manage your users, and more...'] = 'Skapa och organisera kategorier för trådar, hantera dina användare och mer...';
...
$Definition['Discussion  Body'] = 'Tråd  Innehåll';
$Definition['Discussion  Subject'] = 'Tråd  Ämne';
$Definition['Discussion & Comment Editing'] = 'Redigera trådar och svar';
$Definition['Discussion categories are used to help your users organize their discussions in a way that is meaningful for your community.'] = 'Trådkategorier används för att dina användare ska kunna sortera sina trådar på ett sätt som hjälper din community.';

$Definition['discussion(s)'] = 'tråd(ar)';

$Definition['Discussions Layout'] = 'Layout på trådar';
$Definition['Discussions per Page'] = 'Trådar per sida';
...
$Definition['Don\'t display for embedded comments.'] = 'Visa inte inbäddade svar.';
...
$Definition['Embed Comments'] = 'Bädda in svar';
...
$Definition['Enable admin checkboxes on discussions and comments.'] = 'Aktivera kryssrutor för administratörer på trådar och svar.';
...
$Definition['Exclude archived discussions from the discussions list'] = 'Visa inte arkiverade trådar i trådlistan';
...
$Definition['Garden.Import.Merge.Description'] = 'Detta kommer att baka ihop all användardata och alla trådar från importen till ditt forum.
...
$Definition['Hide from the recent discussions page.'] = 'Göm på sidan för senaste trådar.';
$Definition['Hide Pocket Locations'] = 'Göm fickornas platser';
$Definition['Hide this category from the recent discussions page.'] = 'Göm denna kategori på sidan för senaste trådar.';
...
$Definition['It is a good idea to keep the maximum number of characters allowed in a comment down to a reasonable size.'] = 'Det är en bra idé att hålla ner antalet tecken som tillåts i ett svar till en rimlig siffra.';
...
$Definition['Limit the display of this pocket for embedded comments.'] = 'Begränsa visning av den här fickan för inbäddade svar.';
...
$Definition['Marking things as NOT spam will put them back in your forum.'] = 'Om du markerar saker som EJ spam, så visas de igen i ditt forum.';
$Definition['Max Comment Length'] = 'Maxlängd på svar';
...
$Definition['Move discussions in this category to a replacement category.'] = 'Flytta trådar i den här kategorin till en ersättande kategori.';
...
$Definition['New comments in the last day'] = 'Nya svar senaste dygnet';
$Definition['New comments in the last week'] = 'Nya svar senaste veckan';
...
$Definition['New discussions in the last day'] = 'Nya trådar senaste dygnet';
$Definition['New discussions in the last week'] = 'Nya trådar senaste veckan';
...
$Definition['Notify me when people comment on a discussion.'] = 'Meddela mig när någon svarar i en tråd.';
$Definition['Notify me when people comment on my addons.'] = 'Meddela mig när någon kommenterar mina tillägg.';
$Definition['Notify me when people start new discussions.'] = 'Meddela mig när någon startar en ny tråd.';
...
$Definition['Panel Box'] = 'Panel Låda';
...
$Definition['Prevent spam on your forum by limiting the number of discussions &amp; comments that users can post within a given period of time.'] = 'Motverka spam i ditt forum genom att begränsa antalet trådar och svar användare kan skicka inom en viss tidsperiod.';
$Definition['Private Key'] = 'Privat nyckel';
$Definition['Provider'] = 'Leverantör';
$Definition['Proxy Connect'] = 'Proxy Anslutning';
$Definition['Proxy Connect ships with several pre-built <b>Remote Integration Managers</b>, each designed to automate the setup process. If your remote application is listed in the dropdown below, select it now, otherwise choose "Manual Integration".'] = 'Proxy Connect levereras med flera färdiga <b> Remote Integration Managers </b>, var och en utformad för att automatisera installationen. Om fjärr program finns med i drop down listan nedan, välj den nu, annars väljer du "Manuell Integration".';
$Definition['Proxy Connect Test'] = 'Proxy Anslutnings Test';
$Definition['ProxyConnect has been configured to work with your blog, <b>%s</b>. Now would be a good time to Activate the authenticator and do a little testing.'] = 'ProxyConnect har konfigurerats för att fungera med din blogg, <b>%s</ b>. Nu kan vara en bra idé att Aktivera verifieringen och göra lite tester.';
...
$Definition['Refresh Comments'] = 'Uppdatera inlägg';
...
$Definition['Send a confirmation email when people ask a question or start a discussion over email.'] = 'Skicka ett bekräftelsebrev när någon ställer en fråga eller startar en tråd via e-post.';
...
$Definition['Start Discussions'] = 'Starta trådar';
$Definition['Start Import'] = 'Starta import';

$Definition['starting your first discussion'] = 'starta din första tråd';
...
$Definition['This is a parent category that does not allow discussions.'] = 'Det här är en huvudkategori som inte tillåter trådar.';
...
$Definition['This plugin enables uploading files and attaching them to discussions and comments.'] = 'Detta plugin möjliggör uppladdning av filer och att bifoga dem till trådar och svar.';
$Definition['This show the plugin on only selected discussion pages'] = 'Detta visar denna plugin endast på utvalda trådsidor';
...
$Definition['Use categories to organize discussions'] = 'Använd kategorier för att organisera trådar';
...
$Definition['UserDeleteMessage'] = 'Radera användaren och ta helt bort användarens innehåll. Detta kan göra att diskussioner blir osammanhängande. Bästa alternativet för att ta bort spam.';
$Definition['UserDeletionPrompt'] = 'Välj hur du vill hantera innehållet som är associerat med användarkontot för %s (inlägg, meddelanden, osv).';
...
$Definition['UserWipe'] = 'Ersätt användarens innehåll med meddelande';
$Definition['UserWipeMessage'] = 'Radera användaren och ersätt användarens innehåll med ett meddelande om att användaren blivit raderad. Detta ger en visuell indikation på att det finns information som saknas.';
...
$Definition['Vanilla.Archive.Description'] = 'Du kan välja att arkivera forumtrådar som är äldre än ett visst datum. Arkiverade trådar är stängda och tillåter inga nya inlägg.';
...
Om du importerar en väldigt stor f il (t.ex. över 200 000 inlägg) så kanske du bör överväga att ändra din konfiguration. Klicka Click <a href="http://vanillaforums.com/porter">här</a> för mer information.';
...
$Definition['You cannot remove the only remaining category that allows discussions'] = 'Du kan inte radera den enda kvarvarande kategorin som tillåter trådar.';
